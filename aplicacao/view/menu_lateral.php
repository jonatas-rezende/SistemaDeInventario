<nav class="menu">
    <ul class="sidebar-menu metismenu" id="sidebar-menu">
        ...
        <li>
            <a href="">
                <i class="fa fa-area-chart"></i> Consultas <i class="fa arrow"></i>
            </a>
            <ul class="sidebar-nav">
              <li>
                  <a href="consulta_coordenador.php"> Coordenador </a>
              </li>
              <li>
        ...
        <li>
            <a href="">
                <i class="fa fa-file-text-o"></i> Empréstimos Atrasados <i class="fa arrow"></i>
            </a>
            <ul class="sidebar-nav">
            <li>
